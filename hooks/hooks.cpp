...
namespace hooks {
	void load( ) {
		...
		client_hook->hook_function( reinterpret_cast< uintptr_t >( hooked_fsn ), 36 );
		...
		/*engine_hook = new vmthook(reinterpret_cast<DWORD**>(g_csgo.m_engine()));
		engine_hook->hook_function(reinterpret_cast<uintptr_t>(hooked_isHLTV), 93);*/
