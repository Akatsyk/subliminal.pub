...
void eventlogs::add( std::string text, Color color ) {
	...
	g_csgo.m_cvar()->ConsoleColorPrintf(g_cfg.menu.menu_theme[0], "[rolex] ");
	g_csgo.m_cvar()->ConsoleColorPrintf(Color::White, text.c_str());
	g_csgo.m_cvar()->ConsoleColorPrintf(Color::White, "\n");
}
