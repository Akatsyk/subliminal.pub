...
public:
    ...
    void AddCapsuleOverlay(const vec3_t& mins, const vec3_t& maxs, float pillradius, int r, int g, int b, int a, float duration, int unk, int occlude) {
        using AddCapsuleOverlay_t = void(__thiscall*)(void*, const vec3_t&, const vec3_t&, float&, int, int, int, int, float, int, int);
        call_virtual< AddCapsuleOverlay_t >(this, 23)(this, mins, maxs, pillradius, r, g, b, a, duration, unk, occlude);
    }
};