...
void setup_main_menu( ) {
	...
	auto rage_tab = new C_Tab( &menu::get( ), 0, "b", "rage", {
	...
	auto antiaim_tab = new C_Tab( &menu::get( ), 1, "i", "anti-aimbot" ); {
	...
	auto esp_tab = new C_Tab( &menu::get( ), 2, "d", "visualization", { 
		...
		auto esp_2 = new C_GroupBox( GROUP_RIGHT, 8, "" ); {
			...
			auto darkness = new C_SliderInt("darkness", &g_cfg.esp.darkness, 0, 100, "%");
			auto prop_transparency = new C_SliderInt("prop_transparency", &g_cfg.esp.prop_transparency, 0, 100, "%");
	...
	auto misc_tab = new C_Tab(&menu::get(), 3, "c", "miscellaneous"); {
	...
	auto buybot_tab = new C_Tab(&menu::get(), 4, "c", "buy-bot"); {
		auto buybot_default = new C_GroupBox(GROUP_LEFT, 8, ""); {
			
			auto bunnyhop = new C_CheckBox("main buybot", &g_cfg.buy.enable);
			auto main_weapon = new C_Dropdown("main weapon", &g_cfg.buy.main_weapon, { "auto", "ssg-08", "awp" });
			auto sec_weapon = new C_Dropdown("secondary weapon", &g_cfg.buy.sec_weapon, { "default", "heavy-pistol", "duals" });
			auto equipment = new C_MultiDropdown("equipment", &g_cfg.buy.equipment);
		}

		auto buybot_additional = new C_GroupBox(GROUP_RIGHT, 8, ""); {
			auto additional = new C_KeyBind("additional", &g_cfg.buy.additional);
			auto main_weapon = new C_Dropdown("main weapon", &g_cfg.buy.add_main_weapon, { "auto", "ssg-08", "awp" });
			auto sec_weapon = new C_Dropdown("secondary weapon", &g_cfg.buy.add_sec_weapon, { "default", "heavy-pistol", "duals" });
			auto equipment = new C_MultiDropdown("equipment", &g_cfg.buy.add_equipment);
		}
	}
