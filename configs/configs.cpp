...
void C_ConfigManager::setup( ) {
	...
	setup_item(&g_cfg.buy.enable, true, "Buy.enable");
	setup_item(&g_cfg.buy.main_weapon, 0, "Buy.main_weapon");
	setup_item(&g_cfg.buy.sec_weapon, 0, "Buy.sec_weapon");

	setup_item(&g_cfg.buy.additional, BUTTON_CODE_NONE, "Buy.additional_key");
	setup_item(&g_cfg.buy.add_main_weapon, 0, "Buy.add_main_weapon");
	setup_item(&g_cfg.buy.add_sec_weapon, 0, "Buy.add_sec_weapon");


	setup_item(&g_cfg.buy.equipment, {
	{ false, "he grenade" },
	{ false, "smoke grenade" },
	{ false, "inc grenade" },
	{ false, "kit" },
	...
	setup_item(&g_cfg.buy.add_equipment, {
	{ false, "he grenade" },
	{ false, "smoke grenade" },
	{ false, "inc grenade" },
	{ false, "kit" },
	...
	setup_item( &g_cfg.menu.menu_theme[ 0 ], Color( 0, 111, 192 ), "Menu.color[ 0 ]" );
	...
	setup_item(&g_cfg.esp.darkness, 0, "Esp.darkness");
	setup_item(&g_cfg.esp.prop_transparency, 0, "Esp.prop_transparency");
